...
void testMatrix() {
  ...
  const Matrix<4,5,Finite<17>> am = {{8,-4,-5,5,9},
                                     {1,-3,-5,0,-7},
                                     {7,-5,1,4,1},
                                     {3,-1,3,2,5}};
  const Matrix<5,4,Finite<17>> bm = {{4,0,3,2},
                                     {1,-7,4,5},
                                     {7,1,5,3},
                                     {-5,-3,-3,-1},
                                     {1,-5,2,3}};
  ...
  const SquareMatrix<4, Finite<17>> ab = {{-23, -37, -14, 3},
                                          {-41, 51, -48, -49},
                                          {11, 19, -4, -9},
                                          {27, -21, 24, 23}};
  ...
  const Matrix<4,5,Finite<17>> diff = {{4, -5, -12, 10, 8},
                                       {1, 4, -6, 3, -2},
                                       {4, -9, -4, 7, -1},
                                       {1, -6, 0, 3, 2}};
  if (aminusb != diff)
  ...
  std::ifstream in("C:\\Users\\vovun\\Documents\\vovoprograms\\vovo programs\\hw\\Matrix_over_any_field\\lib\\include\\matr.txt");
